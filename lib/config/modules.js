...
let createModule = require('../utils/create-module');

let commonModule = createModule('common');
let securityModule = createModule('security');
let demoModule = createModule('demo', {
    jsToInject: [
        'layouts/**/*.js',
        '**/*.js'
    ]
