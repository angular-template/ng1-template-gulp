...
// Folders
config.folders = require('./lib/core.folders');

// Preferences
config.preferences = require('./lib/preferences');
...
// Shell file
config.shell = require('./lib/core.shell');
...
// Styles
config.styles = require('./lib/styles');
...
config.definitions = require('./lib/typings');

// TSLint config settings
config.tslint = require('./lib/tslint');

// Web server configs
config.webServerConfigs = require('./lib/webserver-configs');

// NPM and Gulp package options
config.options = require('./lib/npm-options');
...
// Server
config.server = require('./lib/core.server');
